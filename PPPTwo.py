...
geocode_request_marks = [f'https://geocode-maps.yandex.ru/1.x/?apikey=40d1649f-0493-4b70-98ba-98533de7710b&format=json&geocode=Санкт-Петербург {i}' for i in marks]
...
map_request = f'https://static-maps.yandex.ru/1.x/?l=map&pl={marks_position}&bbox={lower_corner}~{upper_corner}'
print(map_request)
